...
export const RegisterPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4 py-8">
      <Card className="w-full max-w-md border border-slate-200 shadow-lg rounded-2xl">
        <div className="space-y-6">
          
          <div className="rounded-xl bg-slate-900 text-white p-6 -m-6 mb-6">
            <p className="text-xs uppercase tracking-[0.22em] text-slate-400 mb-3">Cuenta nueva</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                value={values.rol}
                onChange={handleChange}
                className="w-full h-11 px-4 border border-slate-300 rounded-lg bg-white text-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-800"
              >
